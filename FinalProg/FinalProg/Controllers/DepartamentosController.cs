...
namespace FinalProg.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Dep,Nombre_Dep,Codigo_Dep")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Dep,Nombre_Dep,Codigo_Dep")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
